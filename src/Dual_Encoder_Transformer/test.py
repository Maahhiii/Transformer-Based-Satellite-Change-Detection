...
X_test_time1 = X_test[:, :, :, :3]  
X_test_time2 = X_test[:, :, :, 3:]  

X_test_combined = np.concatenate([X_test_time1, X_test_time2], axis=-1)

predictions = model.predict([X_test_combined, X_test_combined], batch_size=4)
